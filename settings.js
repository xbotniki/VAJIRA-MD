...
global.owner = process.env.OWNER_NUMBER  || '94742627972' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=7QViEZgQ#R-HHtqdZwhGN-mO_dnOezshG6LYItjum_WscR--kBRI' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94742627972" : process.env.MODERATORS ,    
